...
CREATE TABLE "public"."systems" (
  ...
  "image_uri" varchar(128) COLLATE "pg_catalog"."default"
)
;
...
SELECT setval('"public"."histories_id_seq"', 10, true);
...
SELECT setval('"public"."systems_id_seq"', 56, true);
