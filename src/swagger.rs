...
#[openapi(
    ...
    components(schemas(
        ...
        attributesvalues_model::AttributeValueModel,
        ...
        attributes_model::NewAttributeWithAttributeValuesModel,
        object_attribute_attributevalue_model::ObjectAttributeAttributeValueModel,
        ...
        rule_question_answer_model::RuleQuestionAnswerModel,
        rule_question_answer_model::NewRuleQuestionAnswerWithoutRuleModel,
        rule_attribute_attributevalue_model::RuleAttributeAttributeValueModel,
