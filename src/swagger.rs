...
#[openapi(
    ...
    components(schemas(
        error::CustomErrors,
        response_body::ResponseBodyError,
        response_body::ResponseBodyEmpty,
        response_body::ResponseBodyAnswers,
        response_body::ResponseBodyAttributeValues,
        response_body::ResponseBodyAttributes,
        response_body::ResponseBodyHistory,
        response_body::ResponseBodyHistories,
        response_body::ResponseBodyObjects,
        response_body::ResponseBodyQuestions,
        response_body::ResponseBodyRule,
        response_body::ResponseBodyRules,
        response_body::ResponseBodyUser,
        response_body::ResponseBodyStartSystem,
        response_body::ResponseBodySystem,
        response_body::ResponseBodySystems,
        answer_model::Answer,
